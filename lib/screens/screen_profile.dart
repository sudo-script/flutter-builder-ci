        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              Row(
                children: [
                  StatCard(value: '142', label: 'Completed', color: const Color(0xFF3B82F6)),
                  SizedBox(width: 9),
                  StatCard(value: '8', label: 'Pending', color: const Color(0xFFF59E0B)),
                  SizedBox(width: 9),
                  StatCard(value: '12', label: 'Day streak', color: const Color(0xFF22C55E)),
                ],
              ),
              SizedBox(height: 28),
              ...
              SizedBox(height: 12),
              SettingsRow(icon: '🔔', label: 'Notifications', hasArrow: true),
              SizedBox(height: 8),
              SettingsRow(icon: '🌙', label: 'Dark Mode', hasArrow: false),
              SizedBox(height: 8),
              SettingsRow(icon: '📊', label: 'Export Data', hasArrow: true),
              SizedBox(height: 40),
              SizedBox(
...
class StatCard extends StatelessWidget {
  ...
  final String label;
  final Color color;
  const StatCard({required this.value, required this.label, required this.color});
...
class SettingsRow extends StatelessWidget {
  ...
  final String label;
  final bool hasArrow;
  const SettingsRow({required this.icon, required this.label, required this.hasArrow});
