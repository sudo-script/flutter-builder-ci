...
class ChipBtn extends StatelessWidget {
  ...
  const ChipBtn({required this.label, required this.selected, required this.onTap});
...
class PriorityBtn extends StatelessWidget {
  ...
  final bool selected;
  final VoidCallback onTap;
  const PriorityBtn({required this.label, required this.color, required this.selected, required this.onTap});
